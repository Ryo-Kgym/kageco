...
export type ChartDetailTableFilterWithdrawalDateQueryVariables = Types.Exact<{
...
export type ChartDetailTableFilterSettlementDateQueryVariables = Types.Exact<{
  groupId: Types.Scalars["String"];
  fromDate: Types.Scalars["date"];
  toDate: Types.Scalars["date"];
}>;
...
export const ChartDetailTableFilterWithdrawalDateDocument = {
  ...
  definitions: [
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "FragmentSpread",
                  name: { kind: "Name", value: "fragTransferCategory" },
                },
              ],
            },
          },
    ...
    },
    {
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "HouseholdTransferCategory" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "incomeCategoryId" } },
          { kind: "Field", name: { kind: "Name", value: "outcomeCategoryId" } },
        ],
      },
    },
  ],
