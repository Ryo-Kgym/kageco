...
export type GetDetailsByAccountIdQueryVariables = Types.Exact<{
...
export const GetDetailsByAccountIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getDetailsByAccountId" },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  alias: { kind: "Name", value: "credits" },
                  name: { kind: "Name", value: "creditCardSummaries" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "where" },
