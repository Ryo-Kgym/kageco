...
export type GetDashboardBalanceQueryVariables = Types.Exact<{
  groupId: Types.Scalars["String"];
}>;

export type GetDashboardBalanceQuery = {
...
export const GetDashboardBalanceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getDashboardBalance" },
      variableDefinitions: [
        {
  ...
  GetDashboardBalanceQuery,
  GetDashboardBalanceQueryVariables
>;
