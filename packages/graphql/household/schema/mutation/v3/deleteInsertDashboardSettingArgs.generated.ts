...
export type DeleteInsertDashboardSettingArgsMutationVariables = Types.Exact<{
  settingId: Types.Scalars["String"];
  objects:
    | Array<Types.HouseholdDashboardSettingArgsInsertInput>
    | Types.HouseholdDashboardSettingArgsInsertInput;
}>;
