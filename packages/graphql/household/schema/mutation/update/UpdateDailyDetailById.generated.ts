...
export type UpdateDailyDetailByIdMutationVariables = Types.Exact<{
  id: Types.Scalars["String"];
  date: Types.Scalars["date"];
  genreId: Types.Scalars["String"];
  iocomeType: Types.Scalars["String"];
  categoryId: Types.Scalars["String"];
  accountId: Types.Scalars["String"];
  amount: Types.Scalars["numeric"];
  memo: Types.InputMaybe<Types.Scalars["String"]>;
  tagDetails:
    | Array<Types.HouseholdDetailTagInsertInput>
    | Types.HouseholdDetailTagInsertInput;
}>;
