...
export type CreateCreditCardSummaryMutationVariables = Types.Exact<{
  accountId: Types.Scalars["String"];
  count: Types.Scalars["Int"];
  creditCard: Types.Scalars["String"];
  groupId: Types.Scalars["String"];
  id: Types.Scalars["String"];
  totalAmount: Types.Scalars["numeric"];
  withdrawalDate: Types.Scalars["date"];
}>;
